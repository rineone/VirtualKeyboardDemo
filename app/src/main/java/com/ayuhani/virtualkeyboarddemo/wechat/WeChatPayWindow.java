...
//        ivIcon = contentView.findViewById(R.id.iv_icon);
        ...
        tvRightType = contentView.findViewById(R.id.tv_right_type);
        ...
        tvConfirmPay = contentView.findViewById(R.id.tv_confirm_pay);
        ...
        tvRightType.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mIsPassword){
                    tvRightType.setText("密码支付");
                    mIsPassword = false;
